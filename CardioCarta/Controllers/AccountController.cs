...
namespace CardioCarta.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            SpecialitiesController specialitiesController = new SpecialitiesController();
            ViewBag.Specialities = new SelectList(specialitiesController.GetSpecialitiesList());
            return View();
        }
        ...
        public async Task<ActionResult> RegisterDoctor(RegisterDoctorViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var doctor = new Doctor { AspNetUsers_Id = user.Id, Speciality_Name = model.Speciality };
